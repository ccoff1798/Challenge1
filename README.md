...
* **User Story**: AS A CODER, THIS WEBSITE WILL SHOW THE AMOUNT OF KNOWLEDGE GAINED OVER SEMANTIC HTML THROUGH OUR WEEK IN CLASS. THIS DEMONSTRATES KNOWNLEDGE OF BASIC CSS AND HTML TO THE LEVEL THAT I CAN EDIT EXISTING CODE TO MAKE IT MORE COMPACT AND ACCESSIBLE.
* **Acceptance Criteria**: IF THE CODE IS VIEWED
*  THEN I SHOULD BE ABLE TO SEE THE SEMANTIC HTML
*  IF THE CODE IS PROPERLY INPUTTED INTO GITHUB
*  THEN GRADERS WILL BE ABLE TO REVIEW MY CODE AND ACCESS MY WEBPAGE
*  IF IT IS SUCESSFULLY UPLOADED TO THE SERVER
*  THEN I CAN ACCESS IT FROM ANY COMPUTER WITH THE URL
*  IF THE PROJECT RESMBLES THE MOCKUP
